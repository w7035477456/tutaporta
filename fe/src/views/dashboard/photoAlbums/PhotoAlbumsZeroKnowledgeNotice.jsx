 ...
 */
export default function PhotoAlbumsZeroKnowledgeNotice({ sx }) {
  return (
    <Box component="aside" role="note" sx={{ ...defaultNoticeSx, ...(sx || null) }}>
      <Box component="strong" sx={titleSx}>
        {PHOTO_ALBUMS_ZERO_KNOWLEDGE_TITLE}
      </Box>
...
PhotoAlbumsZeroKnowledgeNotice.propTypes = {
  sx: PropTypes.object
};
