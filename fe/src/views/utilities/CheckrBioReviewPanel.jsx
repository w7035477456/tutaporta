...
const OPTIONAL_PASSPORT_SECTION_BANNER = 'Beside below info (zoom in photo, citizenship, and POB) we never capture/store any other passport informations or passport ID on this server';
