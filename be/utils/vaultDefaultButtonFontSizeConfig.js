/** myNote menu button default label size (~/.ssh/be/.env NOTES_DEFAULT_BUTTON_FONT_SIZE_REM). */
const DEFAULT_VAULT_BUTTON_FONT_SIZE_REM = 2;

export function getVaultDefaultButtonFontSizeRem() {
  const raw = String(process.env.NOTES_DEFAULT_BUTTON_FONT_SIZE_REM ?? '').trim();
