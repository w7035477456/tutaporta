import { fetchRecordVaultNoteAttachmentBlob } from 'api/recordVaultFe';
import { getRecordVaultAttachmentViewKind } from 'utils/recordVaultFileFormats';
 ...
 */
export async function openRecordVaultAttachmentInNewWindow({
  noteId,
  attachment,
  storageType = null,
