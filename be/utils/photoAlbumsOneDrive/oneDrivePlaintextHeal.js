...
import { openVaultBuffer } from '../photoAlbumsUsb/vaultCrypto.js';
import {
...
import { rvCloudLog } from '../photoAlbumsCloudDebugLog.js';
...
export async function ensurePlaintextOneDriveVaultStaging(singlesId, mountPath, { upload = false } = {}) {
  if (!isPhotoAlbumsIconEncryptionEnabled()) return false;
