...
import { VAULT_REFILL_BLOCK_MB } from './vaultTransferTracking.js';
...
/**
 * Credit complimentary TutaNotes Tx/Rx data for a brand-new member and write a $0
  ...
  if (singlesColumns.has('refill_remain_mb')) {
    ...
    await client.query(
      `UPDATE helloworldjunktest.singles
       SET refill_remain_mb = $1 - COALESCE(notes_total_transfer_mb, 0)${setBought}
       WHERE singles_id = $2`,
      [courtesyMb, id]
    );
  }
