...
import {
  ...
  wrapDek,
  VAULT_E2E_KDF
} from './photoAlbumsClientVaultCrypto';
...
export function isPhotoAlbumsInnerEncryptedBody(bodyText) {
 ...
 */
export async function encryptPhotoAlbumsNoteInnerBody(plainBody, pin, _existingSaltBase64 = null) {
...
export async function decryptPhotoAlbumsNoteInnerBody(encryptedBody, pin, saltBase64 = null) {
  if (!isValidInnerEncryptPin(pin)) {
    throw new Error('PIN must be exactly 6 digits');
  }
