...
export const PHOTO_ALBUMS_TREE_RELOAD_EVENT = 'record-vault-tree-reload';
...
export function notifyPhotoAlbumsTreeReload(storageType) {
  if (typeof window === 'undefined') return;
  window.dispatchEvent(
    new CustomEvent(PHOTO_ALBUMS_TREE_RELOAD_EVENT, {
