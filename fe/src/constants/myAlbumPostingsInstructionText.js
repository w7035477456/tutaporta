/**
 * My Album & Posts (/myStory) page-instruction copy for TTS.
 * Keep bake script in sync:
 *   be/scripts/generateMyAlbumPostingsInstructionTutorialGemini.js
 */
export const MY_ALBUM_POSTINGS_INSTRUCTION_CONTEXT_TITLE = 'Current Context Tutorial';
export const MY_ALBUM_POSTINGS_INSTRUCTION_CONTEXT_STEP = 'You are in: My Albums and Postings.';

/** Flat narration text (matches MyAlbumPostingsInstructionBody). */
export const MY_ALBUM_POSTINGS_INSTRUCTION_SPEAK_TEXT = [
