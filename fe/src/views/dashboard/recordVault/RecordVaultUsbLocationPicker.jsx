...
import { fetchRecordVaultUsbLocations } from 'api/recordVaultFe';
import { formatRecordVaultBridgeClientError } from 'api/recordVaultBridgeFe';
...
export default function RecordVaultUsbLocationPicker({
  selectedPath,
  preferredMountPath = '',
  ...
  return (
    <Box sx={pickerShellSx}>
      ...
      <Typography sx={{ px: 1, pt: 0.75, pb: 0.25, fontWeight: 700, lineHeight: 1.3, fontSize: 'inherit' }}>
        Choose a USB Drive below to mount as TutaNotes
      </Typography>
          ...
          return (
            ...
            >
              <Box sx={tutaNotesRadioControlWrapSx}>
                ...
                />
                <TutaNotesRadioMark selected={selected} disabled={blocked} />
              </Box>
