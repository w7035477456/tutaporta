...
CREATE INDEX IF NOT EXISTS idx_notes_notebook_active_order
...
CREATE INDEX IF NOT EXISTS idx_notes_search_text ON notes(search_text);
`;
...
export const DEFAULT_NOTEBOOKS = ['Notebook 1', 'Notebook 2', 'Notebook 3'];
