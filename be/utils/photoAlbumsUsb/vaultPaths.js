...
export const VAULT_DIR_NAME = 'TutaPhotoAlbums';
/** Older USB folder name — still opened if present; new formats use VAULT_DIR_NAME. */
export const LEGACY_VAULT_DIR_NAMES = ['OMPhotoAlbums'];
...
/** Plain filenames when vault meta is v3/none or PHOTOALBUMS_ENCRYPT_PHOTO_AND_DB=false. */
