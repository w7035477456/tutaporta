...
import { fetchPhotoAlbumsOneDriveVaultTree, fetchPhotoAlbumsUsbVaultTree } from 'api/photoAlbumsFe';
...
export default function PhotoAlbumsOneDriveVaultTreePanel({
  active = true,
  ...
  useEffect(() => {
    ...
    const load = isUsb ? fetchPhotoAlbumsUsbVaultTree() : fetchPhotoAlbumsOneDriveVaultTree();
    void load
      .then((result) => {
        if (cancelled) return;
      ...
      {showDescriptions ? (
        <>
          ...
          <ColorTemplate16PopupCenterWide.SectionDescription sx={{ mb: 0 }}>
            ...
            rotation and hash protection and triple layers verification give MyPhotoAlbums iron clad impenetrable privacy.
          </ColorTemplate16PopupCenterWide.SectionDescription>
        </>
      ) : null}
