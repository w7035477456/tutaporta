...
import { isValidInnerEncryptPin } from 'utils/photoAlbumsNoteInnerCrypto';
import {
...
import VaultOverageThrottleNotice from 'ui-component/PhotoAlbumsOverageThrottleNotice';
import { lockGifSrc } from './PhotoAlbumsEncryptDecryptVideoOverlay';
import PhotoAlbumsZeroKnowledgeNotice, {
  PHOTO_ALBUMS_ZERO_KNOWLEDGE_BODY
} from './PhotoAlbumsZeroKnowledgeNotice';
...
/** @deprecated Prefer PHOTO_ALBUMS_ZERO_KNOWLEDGE_BODY from PhotoAlbumsZeroKnowledgeNotice. */
export const INNER_ENCRYPT_PIN_SECURITY_NOTICE = PHOTO_ALBUMS_ZERO_KNOWLEDGE_BODY;
...
export default function PhotoAlbumsNoteInnerEncryptDialog({
  open,
  mode = 'enable',
  noteName = '',
  scope = 'note',
...
PhotoAlbumsNoteInnerEncryptDialog.propTypes = {
  open: PropTypes.bool,
