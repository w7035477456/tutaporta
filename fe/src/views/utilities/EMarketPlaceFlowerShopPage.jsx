...
export default function EMarketPlaceFlowerShopPage() {
  ...
  const { darkThemeActive, pageTextColor, filterTextColor, titleFontSx, friendsBackgroundBoxSx } = useFriendsThemeBackground();
  ...
  const selectedTopFilterLabel = priceFilter !== 'all' ? selectedPriceLabel : productFilter !== 'all' ? selectedProductLabel : selectedOccasionLabel;
  ...
  const recipientAddress = setupData?.recipient?.send_to_address || null;
  const recipientName = splitFullName(recipientAddress?.full_name);
  ...
  const tokenizeCard = () =>
    new Promise((resolve, reject) => {
      ...
      window.Accept.dispatchData(secureData, (response) => {
        ...
        const msg = response?.messages?.message?.map((m) => m?.text).filter(Boolean).join(' | ') || 'Failed to tokenize card';
    ...
    >
      <Box sx={friendsBackgroundBoxSx}>
        <Stack spacing={2.2}>
          ...
          Browse flower products first. Recipient will be selected in checkout before placing order.
        </Typography>
          ...
          <Stack spacing={2}>
            ...
            {selectionStep === 'browse' ? (
              ...
              >
                ...
                >
                  <ListSubheader sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }}>Occasions</ListSubheader>
                  <MenuItem selected={occasionFilter === 'all' || occasionFilter === 'everyday'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:all')}>
                    Everyday
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'mothersday'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:mothersday')}>
                    Mother&apos;s Day
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'bestsellers'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:bestsellers')}>
                    Best Sellers
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'getwell'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:getwell')}>
                    Get Well
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'sympathy'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:sympathy')}>
                    Funeral & Sympathy
                  </MenuItem>
                  <MenuItem
                  ...
                  <MenuItem selected={occasionFilter === 'thankyou'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:thankyou')}>
                    Thank You
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'birthday'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:birthday')}>
                    Birthday
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'anniversary'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:anniversary')}>
                    Anniversary
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'love'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:love')}>
                    Love & Romance
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'valentines'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:valentines')}>
                    Valentine&apos;s Day
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'easter'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:easter')}>
                    Easter
                  </MenuItem>
                  <MenuItem selected={occasionFilter === 'christmas'} sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('occasion:christmas')}>
                    Christmas
                  </MenuItem>
                  <ListSubheader sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }}>Product Types</ListSubheader>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:centerpieces')}>
                    Centerpieces
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:onesided')}>
                    One Sided Arrangements
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:roses')}>
                    Roses
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:mixed')}>
                    Vase Arrangements
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:plants')}>
                    Plants
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:baskets')}>
                    Fruit Baskets
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:balloons')}>
                    Balloons
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('product:funeralwreaths')}>
                    Funeral Wreaths
                  </MenuItem>
                  <ListSubheader sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }}>Prices</ListSubheader>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('price:u60')}>
                    Under $60
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('price:60t80')}>
                    Between $60 and $80
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('price:80t100')}>
                    Between $80 and $100
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('price:a100')}>
                    Over $100
                  </MenuItem>
                  <MenuItem sx={{ fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() } }} onClick={() => onCatalogFilterPick('clear-all')}>
                    Clear All Filters
                  </MenuItem>
                </Menu>
              ...
              <Stack spacing={1.8} sx={{ maxWidth: 860, width: '100%', mx: 'auto' }}>
                ...
                >
                  <Typography sx={{ color: 'var(--theme-primary-color)', fontWeight: 700, mb: 1 }}>Send To Address</Typography>
                  <Stack spacing={1}>
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                      ...
                      <TextField
                        label="Email"
                        value={String(recipientAddress?.email || '')}
                        InputProps={{ readOnly: true }}
                        fullWidth
                        sx={themedFieldSx}
                      />
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                      <TextField
                        label="Phone"
                        value={String(recipientAddress?.phone_masked || '')}
                        InputProps={{ readOnly: true }}
                        fullWidth
                        sx={themedFieldSx}
                      />
                      <TextField
                        label="Street"
                        value={String(recipientAddress?.street || '')}
                        InputProps={{ readOnly: true }}
                        fullWidth
                        sx={themedFieldSx}
                      />
                      <TextField
                        label="City"
                        value={String(recipientAddress?.city || '')}
                        InputProps={{ readOnly: true }}
                        fullWidth
                        sx={themedFieldSx}
                      />
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                      <TextField
                        label="Zip"
                        value={String(recipientAddress?.zip || '')}
                        InputProps={{ readOnly: true }}
                        fullWidth
                        sx={themedFieldSx}
                      />
                      <TextField
                        label="Country"
                        value={String(recipientAddress?.country || '')}
                        InputProps={{ readOnly: true }}
                        fullWidth
                        sx={themedFieldSx}
                      />
                ...
                {!hasInitialTarget ? (
                  <Typography sx={{ color: 'var(--theme-primary-color)' }}>
                    Recipient is selected during checkout.
                  </Typography>
                ) : null}
                {selectedProduct ? (
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.2} alignItems={{ xs: 'flex-start', sm: 'center' }}>
                      ...
                      <Box sx={{ flex: 1 }}>
                        ...
                        <Typography sx={{ fontSize: '0.84rem', color: '#555' }}>
                          {selectedProduct.amount != null ? `$${Number(selectedProduct.amount).toFixed(2)}` : 'Price available at checkout'}
                        </Typography>
                      </Box>
                      <Button
                        variant="contained"
                ...
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                  <TextField
                    ...
                    onChange={(e) => setCardForm((prev) => ({ ...prev, expMonth: String(e.target.value || '').replace(/\D/g, '').slice(0, 2) }))}
                    fullWidth
                    sx={themedFieldSx}
                  />
                  <TextField
                    ...
                    onChange={(e) => setCardForm((prev) => ({ ...prev, expYear: String(e.target.value || '').replace(/\D/g, '').slice(0, 4) }))}
                    fullWidth
                    sx={themedFieldSx}
                  />
                  <TextField
                    ...
                    onChange={(e) => setCardForm((prev) => ({ ...prev, cardCode: String(e.target.value || '').replace(/\D/g, '').slice(0, 4) }))}
                    fullWidth
                    sx={themedFieldSx}
                  />
                  <TextField
                    label="Billing Zip"
                    value={cardForm.zip}
                    onChange={(e) => setCardForm((prev) => ({ ...prev, zip: String(e.target.value || '').replace(/[^\w\- ]/g, '').slice(0, 10) }))}
                    fullWidth
                    sx={themedFieldSx}
                  />
                </Stack>
                ...
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ pt: 1 }}>
                  ...
                  <Button
                    ...
                    disabled={placingOrder || !productId || !acceptScriptReady || authNetLoading || !Number.isFinite(targetSinglesId) || targetSinglesId < 1}
                    fullWidth
                    sx={{
                      fontSize: { xs: getMobileSinglesButtonFontSizeVw(), sm: getDesktopButtonFontSizeVw() },
                      textTransform: 'none',
