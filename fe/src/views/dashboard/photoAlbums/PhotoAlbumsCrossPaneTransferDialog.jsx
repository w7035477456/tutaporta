...
function storageLabel(storageType) {
  return storageType === 'onedrive' ? 'TutaPhotoAlbums Cloud' : 'TutaPhotoAlbums USB';
}

export default function PhotoAlbumsCrossPaneTransferDialog({
  open,
  item = null,
      ...
      <ColorTemplate16PopupCenterWide.Body spacing={2}>
        ...
        <Box sx={actionRowSx}>
          <GreenButton
            ...
            disabled={busy}
            onClick={() => onCopy?.()}
            sx={{ ...actionButtonSx, ...tutaPhotoAlbumsYellowPostLoginButtonSx, width: { xs: '100%', sm: 'auto' } }}
          >
            Copy
          </GreenButton>
          <GreenButton
            ...
            disabled={busy}
            onClick={() => onMove?.()}
            sx={{ ...actionButtonSx, ...tutaPhotoAlbumsOrangePostLoginButtonSx, width: { xs: '100%', sm: 'auto' } }}
          >
            Move
          </GreenButton>
...
PhotoAlbumsCrossPaneTransferDialog.propTypes = {
  open: PropTypes.bool,
